		...
		public function form( $instance ) {
			...
			<p>
				...
				<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'color_scheme' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'color_scheme' ) ); ?>">
					...
					$color_scheme_arr = array("Light font, Accent background" => "light-accent", "Dark font, Light background" => "dark-light", "Light font, Dark background" => "light-dark", "Accent font, Light background" => "accent-light", "Light font, Accent Gradient background" => "accent-gradient", "Light font, Alternate background" => "light-alternate", );

					$color_scheme_arr = array("Light font, Accent background" => "light-accent", "Dark font, Light background" => "dark-light", "Light font, Dark background" => "light-dark", "Accent font, Light background" => "accent-light", );

					$color_scheme_arr = array("Light font, Accent background" => "light-accent", "Dark font, Light background" => "dark-light", "Light font, Dark background" => "light-dark", "Accent font, Light background" => "accent-light", "Light font, Accent Gradient background" => "accent-gradient", );
...
if ( ! function_exists( 'ippsum_register_widgets' ) ) {
	function ippsum_register_widgets() {
		register_widget( 'BB_Button_Widget' );
	}
}
add_action( 'widgets_init', 'ippsum_register_widgets' );