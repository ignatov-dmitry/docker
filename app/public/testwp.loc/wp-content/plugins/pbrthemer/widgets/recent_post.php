...
class Pbr_Themer_Recent_Post extends Pbr_Themer_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'pbr_recent_post',
            // Widget name will appear in UI
            __('PBR Recent Posts Widget', 'pbrthemer'),
            // Widget description
            array( 'description' => __( 'Show list of recent post', 'pbrthemer' ), )
        );
...
// Widget Backend
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php _e( 'Num Posts:', 'pbrthemer' ); ?></label>
...
register_widget( 'Pbr_Themer_Recent_Post' );