...
$anton_page_layouts = apply_filters( 'uno_fnc_get_archive_sidebar_configs', null );
...
<div id="main-container" class="<?php echo apply_filters('anton_template_main_container_class','container');?> inner <?php echo anton_fnc_theme_options('blog-archive-layout') ; ?>">
	<div class="row">
		...
		<div id="main-content" class="main-content col-lg-12 <?php echo esc_attr($anton_page_layouts['main']['class']); ?>">
					...
					<header class="archive-header">
						<h1 class="archive-title">
							<?php
								...
								printf( esc_html__( 'All posts by %s', 'anton' ), get_the_author() );
							?>
						</h1>
