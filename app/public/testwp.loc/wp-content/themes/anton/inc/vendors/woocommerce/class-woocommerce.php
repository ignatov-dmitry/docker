...
class Anton_Woocommerce{
	...
	public function __construct(){
        ...
        if( anton_fnc_theme_options('is-quickview',true) ){
            add_action( 'wp_ajax_anton_quickview', array($this,'quickview') );
            add_action( 'wp_ajax_nopriv_anton_quickview', array($this,'quickview') );
            add_action( 'wp_footer', array($this,'quickviewModal') );
	    }

        if( anton_fnc_theme_options( 'is-swap-effect',true ) ){
    ...
    public function swapImages(){
        ...
        if(has_post_thumbnail()){
            ...
            $output .= '<img src="'.woocommerce_placeholder_img_src().'" alt="'. esc_attr(get_bloginfo('name', 'display')) . '" class="'.$class.'" width="'.$placeholder_width.'" height="'.$placeholder_height.'" />';
        }
        echo trim($output);
    }
    ...
    public function loadThemeStyles() {
        $current = anton_fnc_theme_options( 'skin','default' );
        if($current == 'default'){
            $path =  get_template_directory_uri() .'/css/woocommerce.css';
        }else{
            $path =  get_template_directory_uri() .'/css/skins/'.$current.'/woocommerce.css';
        }
        wp_enqueue_style( 'anton-woocommerce', $path , 'anton-woocommerce-front' , ANTON, 'all' );
    }
	...
	public function registerCustomizer( $wp_customize ){
		$wp_customize->add_panel( 'panel_woocommerce', array(
    		...
    		'theme_supports' => '',
    		'title' => esc_html__( 'Woocommerce', 'anton' ),
        ...
        $wp_customize->add_control('pbr_theme_options[woo-show-minicart]', array(
            ...
            'label'     => esc_html__('Enable Mini Basket', 'anton'),
        ...
        $wp_customize->add_control('pbr_theme_options[is-quickview]', array(
            ...
            'label'     => esc_html__('Enable QuickView', 'anton'),
            'section'   => 'wc_general_settings',
            'type'      => 'checkbox',
            'transport' => 4,
        ) );
        ...
        $wp_customize->add_control('pbr_theme_options[is-swap-effect]', array(
            ...
            'label'     => esc_html__('Enable Swap Image', 'anton'),
            'section'   => 'wc_general_settings',
            'type'      => 'checkbox',
            'transport' => 4,
        ) );
        ...
        $wp_customize->add_section( 'wc_archive_settings', array(
            ...
            'capability' => 'edit_theme_options',
            'theme_supports' => '',
            'title' => esc_html__( 'Archive Page Setting', 'anton' ),
        ...
        $wp_customize->add_control( new Anton_Layout_DropDown( $wp_customize,  'pbr_theme_options[woocommerce-archive-layout]', array(
       ...
       //sidebar archive left
        ...
        $wp_customize->add_control( new Anton_Sidebar_DropDown( $wp_customize,  'pbr_theme_options[woocommerce-archive-left-sidebar]', array(
        ...
        $wp_customize->add_control( new Anton_Sidebar_DropDown( $wp_customize,  'pbr_theme_options[woocommerce-archive-right-sidebar]', array(
        ...
        $wp_customize->add_control( 'pbr_theme_options[woo-number-page]', array(
            'label'      => esc_html__( 'Number of Products Per Page', 'anton' ),
            'section'    => 'wc_archive_settings',
            'priority' => 6
        ) );
        ...
        $wp_customize->add_control( 'pbr_theme_options[wc_itemsrow]', array(
            'label'      => esc_html__( 'Number of Products Per Row', 'anton' ),
            'section'    => 'wc_archive_settings',
            'type'       => 'select',
            'choices'     => array(
                '2' => esc_html__('2 Items', 'anton' ),
                '3' => esc_html__('3 Items', 'anton' ),
                '4' => esc_html__('4 Items', 'anton' ),
                '6' => esc_html__('6 Items', 'anton' ),
            ),
            'priority' => 7
        ) );
    	...
    	$wp_customize->add_section( 'wc_product_settings', array(
    		...
    		'capability' => 'edit_theme_options',
    		'theme_supports' => '',
    		'title' => esc_html__( 'Single Product Page Setting', 'anton' ),
        ...
        //Select layout
        $wp_customize->add_control( new Anton_Layout_DropDown( $wp_customize,  'pbr_theme_options[woocommerce-single-layout]', array(
            'settings'  => 'pbr_theme_options[woocommerce-single-layout]',
            'label'     => esc_html__('Product Detail Layout', 'anton'),
        ...
        //Sidebar left
        $wp_customize->add_control( new Anton_Sidebar_DropDown( $wp_customize,  'pbr_theme_options[woocommerce-single-left-sidebar]', array(
            'settings'  => 'pbr_theme_options[woocommerce-single-left-sidebar]',
            'label'     => esc_html__('Product Detail Left Sidebar', 'anton'),
            'section'   => 'wc_product_settings',
            'priority' => 2 
        ) ) );
        ...
        //Sidebar right
        $wp_customize->add_control( new Anton_Sidebar_DropDown( $wp_customize,  'pbr_theme_options[woocommerce-single-right-sidebar]', array(
            'settings'  => 'pbr_theme_options[woocommerce-single-right-sidebar]',
            'label'     => esc_html__('Product Detail Right Sidebar', 'anton'),
            'section'   => 'wc_product_settings',
            'priority' => 3 
        ) ) );
        ...
        $wp_customize->add_control('pbr_theme_options[wc_show_related]', array(
            ...
            'label'     => esc_html__('Disable show related product', 'anton'),
            'section'   => 'wc_product_settings',
            'type'      => 'checkbox',
            'priority' => 4
        ) );
        ...
        $wp_customize->add_control('pbr_theme_options[wc_show_upsells]', array(
            ...
            'label'     => esc_html__('Disable show upsells product', 'anton'),
            'section'   => 'wc_product_settings',
            'type'      => 'checkbox',
            'transport' => 3,
            'priority' => 5
        ...
        $wp_customize->add_control( 'pbr_theme_options[product-number-columns]', array(
            'label'      => esc_html__( 'Number of Product Per Row', 'anton' ),
            'section'    => 'wc_product_settings',
            'type'       => 'select',
            'choices'     => array(
                '2' => esc_html__('2 Items', 'anton' ),
        ...
        $wp_customize->add_control( 'pbr_theme_options[woo-number-product-single]', array(
            'label'      => esc_html__( 'Number of Products to Show', 'anton' ),
            'section'    => 'wc_product_settings',
            'priority' => 7
        ) );
        ...
        $wp_customize->add_control('pbr_theme_options[wc_show_share_social]', array(
            ...
            'label'     => esc_html__('Show Social share product', 'anton'),
            'section'   => 'wc_product_settings',
            'type'      => 'checkbox',
            'priority' => 8
        ) );
                                ...
                                <div class="summary entry-summary">
                                    <?php
                                        ...
                                        */
                                        ...
                                        printf( _n( '(%s review)', '(%s reviews)', $product->get_review_count(), 'anton' ), '<span itemprop="reviewCount" class="count">' . $product->get_review_count() . '</span>' );
