 ...
 * @since Anton 1.0
 *
 * @uses anton_fnc_header_style()
 * @uses anton_fnc_admin_header_style()
 * @uses anton_fnc_admin_header_image()
 */
function anton_fnc_custom_header_setup() {
	/**
	 ...
	 * }
	 */
	add_theme_support( 'custom-header', apply_filters( 'anton_fnc_custom_header_args', array(
		'default-text-color'     => 'fff',
		'width'                  => 1260,
		'height'                 => 240,
		'flex-height'            => true,
		'wp-head-callback'       => 'anton_fnc_header_style',
		'admin-head-callback'    => 'anton_fnc_admin_header_style',
		'admin-preview-callback' => 'anton_fnc_admin_header_image',
	) ) );
}
add_action( 'after_setup_theme', 'anton_fnc_custom_header_setup' );

if ( ! function_exists( 'anton_fnc_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see anton_fnc_custom_header_setup().
 *
 */
function anton_fnc_header_style() {  
	...
	?>
	<style type="text/css" id="anton-header-css">
		<?php 
...
endif; // anton_fnc_header_style


if ( ! function_exists( 'anton_fnc_admin_header_style' ) ) :
/**
 ...
 * @since Anton 1.0
 */
function anton_fnc_admin_header_style() {  
?>
	<style type="text/css" id="anton-admin-header-css">
...
endif; // anton_fnc_admin_header_style

if ( ! function_exists( 'anton_fnc_admin_header_image' ) ) :
/**
 ...
 * @since Anton 1.0
 */
function anton_fnc_admin_header_image() {
?>
	<div id="headimg">
		<?php if ( get_header_image() ) : ?>
		<img src="<?php header_image(); ?>" alt="'. esc_attr(get_bloginfo('name', 'display')) . '">
		<?php endif; ?>
...
endif; // anton_fnc_admin_header_image