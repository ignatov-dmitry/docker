...
if(has_post_thumbnail()){
	...
	$_images[] = '<img src="'.wc_placeholder_img_src().'" alt="' . esc_attr(get_bloginfo('name', 'display')) . '" />';
	$_paginates[] = '<img src="'.wc_placeholder_img_src().'" alt="' . esc_attr(get_bloginfo('name', 'display')) . '" width="50" height="50" />';
}
