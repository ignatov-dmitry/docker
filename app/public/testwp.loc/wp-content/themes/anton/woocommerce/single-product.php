...
<div id="main-container" class="<?php echo apply_filters('uno_template_woocommerce_main_container_class','container');?>">
	<div class="row">

		<?php if( isset($uno_page_layouts['sidebars']) && !empty($uno_page_layouts['sidebars']) ) : ?>
			<?php get_sidebar(); ?>
		<?php endif; ?>
...
<?php do_action( 'uno_woo_template_main_before' ); ?>
<?php
