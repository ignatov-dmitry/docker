    ...
    if ($instance[$key]) : 
        switch ($key) { 
            ...
            case 'company':
                ?>
                    <div class="<?php echo esc_attr( $key ) ?>">
                        <p class="desc"><?php esc_attr_e('head Office', 'anton') ?> </p>
            ...
            case 'phone':
                ?>  <div class="<?php echo esc_attr( $key ) ?>">
                    <i class="<?php echo esc_attr( $instance[$key.'_class'] ); ?>" ></i><p class="phone-number"><?php if($instance[$key]) { echo esc_html( $instance[$key] ); } else { echo esc_html( $instance[$key] ); } ?></p>
                    </div>
                <?php 
                break;
