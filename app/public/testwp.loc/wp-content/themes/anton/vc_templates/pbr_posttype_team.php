...
switch ($columns_count) {
	case '6': 
		...
		break;
	case '5':
		$class_column='col-lg-5 col-md-5 col-sm-6';
		break;
	case '4':
...
?>
<div class="widget widget-team <?php echo (($el_class!='')?' '.esc_attr( $el_class ):''); ?>">
	<?php if( $title ){ ?> 
	...
	<div class="widget-content">
		<div class="row">
			...
			?>
			<div class="team-item <?php echo esc_attr( $class_column); ?>">
