    ...
    <div class="widget_deals_products widget <?php echo (($el_class!='')?' '.esc_attr( $el_class ):''); ?>">
        ...
        <?php if($layout == 'carousel'):?>
            <div id="carousel-<?php echo esc_attr($_id); ?>" class="widget-content owl-carousel-play" data-ride="owlcarousel">   
                ...
                <?php } ?>
                 <div class="owl-carousel products product" data-slide="<?php echo esc_attr($columns_count); ?>" data-pagination="true" data-navigation="true" data-desktop="[1199,1]" data-desktopsmall="[980,1]" data-tablet="[768,1]">
                            ...
                            <div class="product <?php echo esc_attr( $class_column ); if($_count%$columns_count==0) echo ' last'; ?>">
                                <div class="product-block media">
                                    ...
                                    <div class="caption media-body">
                                        ...
                                        <div class="meta">
                                            <h3 class="name">
                                                <a href="<?php echo esc_url( get_permalink( $product->get_id() ) ); ?>"><?php echo esc_attr( $product->get_name() ); ?></a>
                                            </h3>
                                            <div class="description"><?php echo anton_fnc_excerpt(20,'...');; ?></div>
