...
@font-face{ font-family:"Details";src:url("' . get_parent_theme_file_uri( 'fonts/Details/Details.woff' ) . '") format("woff"),url("' . get_parent_theme_file_uri( 'fonts/Details/Details.ttf' ) . '") format("truetype"); }
*[data-ico-details]:before{ font-family:Details;content:attr(data-ico-details); }
.bt_bb_icon_preview.bt_bb_icon_preview_details { font-family:Details; }
...
.bt_bb_icon_preview.bt_bb_icon_preview_dripicons { font-family:Dripicons; }
...
.bt_bb_icon_preview.bt_bb_icon_preview_fontawesome { font-family:FontAwesome; }
...
@font-face{ font-family:"Ippsum";src:url("' . get_parent_theme_file_uri( 'fonts/Ippsum/Ippsum.woff' ) . '") format("woff"),url("' . get_parent_theme_file_uri( 'fonts/Ippsum/Ippsum.ttf' ) . '") format("truetype"); }
*[data-ico-ippsum]:before{ font-family:Ippsum;content:attr(data-ico-ippsum); }
.bt_bb_icon_preview.bt_bb_icon_preview_ippsum { font-family:Ippsum; }

@font-face{ font-family:"Points";src:url("' . get_parent_theme_file_uri( 'fonts/Points/Points.woff' ) . '") format("woff"),url("' . get_parent_theme_file_uri( 'fonts/Points/Points.ttf' ) . '") format("truetype"); }
*[data-ico-points]:before{ font-family:Points;content:attr(data-ico-points); }
.bt_bb_icon_preview.bt_bb_icon_preview_points { font-family:Points; }

@font-face{ font-family:"Specific";src:url("' . get_parent_theme_file_uri( 'fonts/Specific/Specific.woff' ) . '") format("woff"),url("' . get_parent_theme_file_uri( 'fonts/Specific/Specific.ttf' ) . '") format("truetype"); }
*[data-ico-specific]:before{ font-family:Specific;content:attr(data-ico-specific); }
.bt_bb_icon_preview.bt_bb_icon_preview_specific { font-family:Specific; }', array() );