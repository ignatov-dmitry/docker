...
boldthemes_add_mb( array( 'id' => 'page', 'title' => esc_html__( 'Settings', 'ippsum' ), 'post_type' => 'page', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'page',
		'field_id' => 'menu_name',
		'name'     => esc_html__( 'Custom Primary Menu Name', 'ippsum' ),
		'type'     => 'select',
		'options'  => $menu_arr
	)
);
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Custom Footer Menu Name', 'ippsum' ),
		'type'     => 'select',
		'options'  => $menu_arr
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'page',
		'field_id' => 'override',
		'name'     => esc_html__( 'Override Global Settings', 'ippsum' ),
		'type'     => 'boldthemestext',
		'clone'    => true
	)
);
...
boldthemes_add_mb( array( 'id' => 'post', 'title' => esc_html__( 'Settings', 'ippsum' ), 'post_type' => 'post', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'menu_name',
...
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Grid Gallery', 'ippsum' ),
		'type'     => 'checkbox'
	)
);
boldthemes_add_mb_field( 
...
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'link_url',
		'name'     => esc_html__( 'Link URL', 'ippsum' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
...
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Quote Author', 'ippsum' ),
		'type'     => 'text'
	)
);
...
boldthemes_add_mb( array( 'id' => 'portfolio', 'title' => esc_html__( 'Settings', 'ippsum' ), 'post_type' => 'portfolio', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'portfolio',
		'field_id' => 'images',
...
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Custom Fields', 'ippsum' ),
...
boldthemes_add_mb( array( 'id' => 'product', 'title' => esc_html__( 'Settings', 'ippsum' ), 'post_type' => 'product', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'product',
		'field_id' => 'override',
