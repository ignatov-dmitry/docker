...
class bt_bb_progress_bar extends BT_BB_Element {
	...
	function map_shortcode() {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Progress Bar', 'ippsum' ), 'description' => esc_html__( 'Progress bar', 'ippsum' ), 'icon' => $this->prefix_backend . 'icon' . '_' . $this->shortcode,
			'params' => array(
				array( 'param_name' => 'percentage', 'type' => 'textfield', 'heading' => esc_html__( 'Percentage', 'ippsum' ), 'preview' => true ),
				...
				array( 'param_name' => 'highlight_text', 'type' => 'dropdown', 'heading' => esc_html__( 'Show percentage', 'ippsum' ), 'group' => esc_html__( 'Design', 'ippsum' ),
					'value' => array(
						esc_html__( 'No', 'ippsum' ) 			=> '',
						esc_html__( 'Yes', 'ippsum' ) 			=> 'visible'
					)
				),
				array( 'param_name' => 'shape', 'type' => 'dropdown', 'default' => 'rounded', 'heading' => esc_html__( 'Shape', 'ippsum' ), 'group' => esc_html__( 'Design', 'ippsum' ),
					'value' => array(
