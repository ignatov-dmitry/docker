...
class bt_bb_counter extends BT_BB_Element {
	...
	function map_shortcode() {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Counter with Icon', 'ippsum' ), 'description' => esc_html__( 'Animated counter with icon and text', 'ippsum' ),  
			...
			'params' => array(
				...
				array( 'param_name' => 'number', 'type' => 'textfield', 'heading' => esc_html__( 'Number', 'ippsum' ), 'preview' => true ),
				array( 'param_name' => 'text', 'type' => 'textfield', 'heading' => esc_html__( 'Text', 'ippsum' ) ),
				...
				array( 'param_name' => 'font_weight', 'type' => 'dropdown', 'heading' => esc_html__( 'Font weight', 'ippsum' ),
					'value' => array(
