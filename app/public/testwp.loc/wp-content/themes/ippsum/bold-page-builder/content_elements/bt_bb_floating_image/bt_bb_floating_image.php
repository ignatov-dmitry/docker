...
class bt_bb_floating_image extends BT_BB_Element {
	...
	function map_shortcode() {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Floating image', 'ippsum' ), 'description' => esc_html__( 'Absolute positioned floating image', 'ippsum' ), 'icon' => $this->prefix_backend . 'icon' . '_' . $this->shortcode, 'as_child' => array( 'only' => 'bt_bb_image, bt_bb_column, bt_bb_column_inner' ),
			'params' => array(
				...
				array( 'param_name' => 'lazy_load', 'type' => 'dropdown', 'default' => 'no', 'heading' => esc_html__( 'Lazy load this image', 'ippsum' ),
					'value' => array(
