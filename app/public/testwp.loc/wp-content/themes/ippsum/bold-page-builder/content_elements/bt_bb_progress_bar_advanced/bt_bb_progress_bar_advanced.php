...
class bt_bb_progress_bar_advanced extends BT_BB_Element {
	...
	function map_shortcode() {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Advanced Progress bar', 'ippsum' ), 'description' => esc_html__( 'Advanced Progress bar', 'ippsum' ), 'container' => 'vertical', 'accept' => false, 'icon' => $this->prefix_backend . 'icon' . '_' . $this->shortcode,
			'params' => array(
				array( 'param_name' => 'type', 'type' => 'dropdown', 'heading' => esc_html__( 'Progress Bar Type', 'ippsum' ), 'preview' => true,
					'value' => array(
						esc_html__( 'Semi circle', 'ippsum' ) 		=> 'semi-circle',
						esc_html__( 'Circle', 'ippsum' ) 			=> 'circle'
					)
				),
				array( 'param_name' => 'percentage', 'type' => 'textfield', 'heading' => esc_html__( 'Percentage', 'ippsum' ), 'description' => esc_html__( 'Enter number from 1 to 100, without %', 'ippsum' ), 'preview' => true ),
				array( 'param_name' => 'duration', 'type' => 'textfield', 'heading' => esc_html__( 'Animation duration', 'ippsum' ), 'preview' => true ),
						array( 'param_name' => 'easing', 'type' => 'dropdown', 'heading' => esc_html__( 'Easing', 'ippsum' ), 'preview' => true,
					'value' => array(
						esc_html__( 'Linear', 'ippsum' ) 			=> 'linear',
						esc_html__( 'Ease In Out', 'ippsum' ) 		=> 'easeInOut',
						esc_html__( 'Bounce', 'ippsum' ) 			=> 'bounce'
					)
				),
				...
				array( 'param_name' => 'url', 'group' => esc_html__( 'URL', 'ippsum' ), 'type' => 'textfield', 'heading' => esc_html__( 'URL', 'ippsum' ) ),
				array( 'param_name' => 'target', 'group' => esc_html__( 'URL', 'ippsum' ), 'type' => 'dropdown', 'heading' => esc_html__( 'URL Target', 'ippsum' ),
					'value' => array(
				...
				array( 'param_name' => 'size', 'type' => 'dropdown', 'default' => 'normal', 'heading' => esc_html__( 'Progress bar size', 'ippsum' ), 'group' => esc_html__( 'Design', 'ippsum' ), 'preview' => true,
					'value' => array(
				...
				array( 'param_name' => 'thickness', 'type' => 'dropdown', 'heading' => esc_html__( 'Progress bar thickness', 'ippsum' ), 'group' => esc_html__( 'Design', 'ippsum' ),
					'value' => array(
						esc_html__( 'Small', 'ippsum' ) 			=> 'small',
						esc_html__( 'Normal', 'ippsum' ) 			=> 'normal',
						esc_html__( 'Medium', 'ippsum' ) 			=> 'medium',
				...
				array( 'param_name' => 'trail_thickness', 'type' => 'dropdown', 'heading' => esc_html__( 'Progress bar trail thickness', 'ippsum' ), 'group' => esc_html__( 'Design', 'ippsum' ),
					'value' => array(
						esc_html__( 'Same as progress bar', 'ippsum' ) 	=> 'progressbar',
						esc_html__( 'Small', 'ippsum' ) 					=> 'small',
						esc_html__( 'Normal', 'ippsum' ) 					=> 'normal',
						esc_html__( 'Medium', 'ippsum' ) 					=> 'medium',
						esc_html__( 'Large', 'ippsum' ) 					=> 'large',
				...
				array( 'param_name' => 'color_from', 'type' => 'colorpicker', 'heading' => esc_html__( 'Starting Progress Bar Background color', 'ippsum' ), 'group' => esc_html__( 'Design', 'ippsum' ) ),
				array( 'param_name' => 'color_to', 'type' => 'colorpicker', 'heading' => esc_html__( 'Ending Progress Bar Background color', 'ippsum' ), 'group' => esc_html__( 'Design', 'ippsum' ) ),
				array( 'param_name' => 'trail_color', 'type' => 'colorpicker', 'heading' => esc_html__( 'Color for lighter trail stroke underneath the actual progress path', 'ippsum' ), 'group' => esc_html__( 'Design', 'ippsum' ) ),
				array( 'param_name' => 'fill_color', 'type' => 'colorpicker', 'heading' => esc_html__( 'Fill color', 'ippsum' ), 'group' => esc_html__( 'Design', 'ippsum' ) )
			)
		) );
	}
}
