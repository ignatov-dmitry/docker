...
<div class="btCartWidget btIconWidget">
	<span class="btCartWidgetIcon btIconWidgetIcon">
		...
		?>
		<span class="cart-contents" title="<?php echo esc_attr__( 'View your shopping cart', 'ippsum' ) ; ?>"><?php echo WC()->cart->get_cart_contents_count(); ?></span>
	</span>
	...
	<div class="btCartWidgetInnerContent btImageTextWidgetWrapper btIconWidgetContent">
		...
		<ul class="cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">
			...
			<?php if ( ! WC()->cart->is_empty() ) : 
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							<li class="<?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
									...
									esc_html__( 'Remove this item', 'ippsum' ),
									esc_attr( $product_id ),
				...
				<li class="empty"><?php echo esc_html__( 'No products in the cart.', 'ippsum' ); ?></li>
	...
	<?php if ( ! WC()->cart->is_empty() ) : ?>
		...
		<p class="total"><strong><?php echo esc_html__( 'Subtotal', 'ippsum' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>

		<?php do_action( 'woocommerce_widget_shopping_cart_before_buttons' ); ?>

		<p class="buttons">
			<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button wc-forward"><?php esc_html( _e( 'View Cart', 'ippsum' ) ); ?></a>
			<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button checkout wc-forward"><?php esc_html( _e( 'Checkout', 'ippsum' ) ); ?></a>
		</p>
